...
// Create Shopify Storefront API Client Fetch ALl Products  
...
const SHOPIFY_STOREFRONT_ACCESS_TOKEN = "0143680c8ac2cb44476b3b1c06e9a205";
const client = createStorefrontApiClient({
  storeDomain: 'http://athayog.myshopify.com',
  apiVersion: '2023-10',
...
export const fetchCartItems = async (checkoutId) => {
  try {
    ...
    return response.data.node.lineItems.edges;
  } catch (error) {
