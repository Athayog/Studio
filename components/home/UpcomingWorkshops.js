...
function UpcomingWorkshops() {
     ...
     const SeptemberData = [
          ...
          { date: '21st', time: '11:00 AM', topic: 'Shatkarma', teacher: 'Ankush' },
          { date: '29th', time: '11:00 AM', topic: 'Expressive Board Yoga Art Therapy', teacher: 'Purvi' }
          // Add more data rows as needed
     ];
     const OctoberData = [
          ...
          { date: '19th & 20th', time: '11:00 AM', topic: 'Yoga Nidra', teacher: 'Shobith' },
          ...
          <Box py={10} maxW="90vw" margin="0 auto">
               ...
               <Box shadow="md" p={5} fontSize="lg" border="1px solid purple">
                    <Flex gap={1} flexDirection="column" flexWrap="wrap">
                         ...
                         <Text pr={10}>
                              Yog Nidra (Single Session) -{' '}
                              <chakra.span fontWeight="bold" color="purple.700">
                                   ₹1200
                              </chakra.span>
                         </Text>
                         <Text pr={10}>
                              Yog Nidra (Both Session) -{' '}
                              <chakra.span fontWeight="bold" color="purple.700">
                                   ₹1800
                              </chakra.span>
                         </Text>
