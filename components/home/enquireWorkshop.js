...
const EnquireWorkshop = ({ size, buttonText="Enquiry Now", colorType="aygreen",titleModal="Enquiry" ,backColor}) => {
     ...
     const onSubmit = async ({
          ...
          await fetch('https://formsubmit.co/ajax/info@athayogliving.com', {
               ...
               body: JSON.stringify({
                    FormType: 'Enquiry Form For Workshop',
                    fullname: fullName,
                    email: email,
                    phone: phone,
                    details: details
     ...
     return (
          ...
          {!backColor ?  <MotionButton
               ...
               >
                    ...
                    colorScheme='purple' size='md' mt={5}
                    transition="all 0.3s"
                    onClick={onOpen}
                    _hover={{
                         color:'#333'
...
export default EnquireWorkshop;
