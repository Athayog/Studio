          ...
          <div>
               ...
               >
                    ...
                    >
                         ...
                         >
                              AthaYog Offline Class April 2023 (Indiranagar)
                         </Heading>
                         <Box
                              overflowX="auto"
                              width="100%"
                    ...
                    >
                         <Heading
                              ...
                              fontSize={{ base: '2xl', md: '3xl' }}
                         >
                              AthaYog Offline Class April 2023 (KR Puram)
                         </Heading>
                         <Box
                              overflowX="auto"
                              width="100%"
                         ...
                         >
                              ...
                              <Badge
                                   ...
                                   mt={3}
                              >
                                   Note: 108 surya namaskar will be happening
                                   only on 1st Saturday of the month (7:00 AM -
                                   9:00 AM){' '}
                              </Badge>
                         </Box>
                    </Flex>
