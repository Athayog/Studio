...
function Classes() {
     const data = [
          ...
          {
               name: 'AthaYog Online',
               desc: `You may be looking to keep your practice going at a steady pace. You can continue from the comfort of your own space.`,
               url: '/classes/online'
          },
          {
               name: 'AthaYog Onsite',
               desc: `AthaYog Onsite is for people seeking Yogic education on their own personal time, from the comfort of their space.`,
               url: '/classes/onsite'
          },
          {
          ...
          {
               name: 'AthaYog Workshops',
               desc: `Experience a profound approach to Yogic knowledge and living. Explore the deeper, subtler and more authentic aspects of Yoga as we share our collective wisdom on specialized and focussed topics in the Yogic realm.`,
     ...
     return (
          <Box bg="primaryWhite">
               <Head>
                    <title>Classes - AthayogLiving</title>
               </Head>
