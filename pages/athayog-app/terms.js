               ...
               <VStack spacing={10} mt={5}>
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              This mobile application is operated by{' '}
                              <strong>Athayog Living</strong>. Throughout the
                              app, the terms “we”, “us” and “our” refer to
                              <strong> Athayog Living</strong>.{' '}
                              <strong>Athayog Living</strong> offers this
                              mobile application, including all information, tools and
                              services available from this app to you, the
                              user, conditioned upon your acceptance of all
                              terms, conditions, policies and notices stated
                              here.
                         </Text>
                         <Text mb={5} fontSize="xl">
                              By visiting our app and/ or purchasing something
                              from us, you engage in our “Service” and agree to
                              ...
                              app, including without limitation users who are
                              browsers, vendors, customers, merchants, and/ or
                              contributors of content.
                         </Text>
                         <Text mb={5} fontSize="xl">
                              Please read these Terms of Service carefully
                              before accessing or using our mobile application. By
                              accessing or using any part of the app, you agree
                              to be bound by these Terms of Service. If you do
                              not agree to all the terms and conditions of this
                              agreement, then you may not access the mobile application or
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              posting updates and/or changes to our mobile application. It
                              is your responsibility to check this page
                              periodically for changes. Your continued use of or
                              access to the mobile application following the posting of any
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              or that you are the age of majority in your state
                              or province of residence and you have given us
                              your consent to allow any of your minor dependents
                              to use this app.
                         </Text>
                         <Text mb={5} fontSize="xl">
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              contact on the mobile application through which the service
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              available on this app is not accurate, complete
                              or current. The material on this app is provided
                              ...
                              accurate, more complete or more timely sources of
                              information. Any reliance on the material on this
                              app is at your own risk.
                         </Text>
                         <Text mb={5} fontSize="xl">
                              This app may contain certain historical
                              ...
                              of this app at any time, but we have no
                              obligation to update any information on our app.
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              exclusively online through the mobile application. These
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              your computer monitor's display of any color will
                              be accurate.
                         </Text>
                         <Text mb={5} fontSize="xl">
                              ...
                              any product or service made on this app is void
                              where prohibited.
                         </Text>
                         <Text mb={5} fontSize="xl">
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              include orders placed by or under the same
                              customer account, the same credit card, and/or
                              orders that use the same billing and/or shipping
                              address. In the event that we make a change to or
                              cancel an order, we may attempt to notify you by
                              contacting the e-mail and/or billing address/phone
                              number provided at the time the order was made. We
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              purchases made at our store. You agree to promptly
                              update your account and other information,
                              including your email address and credit card
                              numbers and expiration dates, so that we can
                              complete your transactions and contact you as
                              needed.
                         </Text>
                         <Text mb={5} fontSize="xl">
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              the app is entirely at your own risk and
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              and/or features through the mobile application (including,
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              Third-party links on this app may direct you to
                              third-party mobile applications that are not affiliated with
                              ...
                              mobile applications, or for any other materials, products, or
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              in connection with any third-party mobile applications.
                              Please review carefully the third-party's policies
                              and practices and make sure you understand them
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              otherwise (collectively, 'comments'), you agree
                              that we may, at any time, without restriction,
                              edit, copy, publish, distribute, translate and
                              otherwise use in any medium any comments that you
                              forward to us. We are and shall be under no
                              obligation (1) to maintain any comments in
                              confidence; (2) to pay compensation for any
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              or proprietary right. You further agree that your
                              ...
                              related mobile application. You may not use a false e-mail
                              address, pretend to be someone other than
                              yourself, or otherwise mislead us or third-parties
                              as to the origin of any comments. You are solely
                              responsible for any comments you make and their
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              Occasionally there may be information on our app
                              or in the Service that contains typographical
                              errors, inaccuracies or omissions that may relate
                              to product descriptions, pricing, promotions,
                              offers, product shipping charges, transit times
                              and availability. We reserve the right to correct
                              any errors, inaccuracies or omissions, and to
                              change or update information or cancel orders if
                              any information in the Service or on any related
                              mobile application is inaccurate at any time without prior
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              related mobile application, including without limitation,
                              pricing information, except as required by law. No
                              specified update or refresh date applied in the
                              Service or on any related mobile application, should be taken
                              to indicate that all information in the Service or
                              on any related mobile application has been modified or
                              updated.
                         </Text>
                    </Box>
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              the Terms of Service, you are prohibited from
                              using the app or its content: (a) for any
                              unlawful purpose; (b) to solicit others to perform
                              or participate in any unlawful acts; (c) to
                              violate any international, federal, provincial or
                              ...
                              insult, harm, defame, slander, disparage,
                              intimidate, or discriminate based on gender,
                              sexual orientation, religion, ethnicity, race,
                              age, national origin, or disability; (f) to submit
                              false or misleading information; (g) to upload or
                              transmit viruses or any other type of malicious
                              code that will or may be used in any way that will
                              affect the functionality or operation of the
                              Service or of any related mobile application, other mobile applications,
                              or the Internet; (h) to collect or track the
                              personal information of others; (i) to spam,
                              ...
                              of the Service or any related mobile application, other
                              mobile applications, or the Internet. We reserve the right to
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              for your use, without any representation,
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              loss, claim, or any direct, indirect, incidental,
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              <strong>Athayog Living</strong> and our parent,
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              applicable law, and the unenforceable portion
                              shall be deemed to be severed from these Terms of
                              Service, such determination shall not affect the
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              operating rules posted by us on this app or in
                    ...
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              whereby we provide you Services shall be governed
                              by and construed in accordance with the laws of
                              India and jurisdiction of Banglore, Karnataka
                         </Text>
                    </Box>
                    <Box width="100%" fontWeight="light" fontSize="lg">
                         <Heading
                         ...
                         <Text mb={5} fontSize="xl">
                              ...
                              update, change or replace any part of these Terms
                              of Service by posting updates and changes to our
                              mobile application. It is your responsibility to check our
                              mobile application periodically for changes. Your continued
                              use of or access to our mobile application or the Service
                              following the posting of any changes to these
