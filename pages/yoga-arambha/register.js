...
const Register = () => {
  const { register, handleSubmit, watch, formState: { errors }, setValue, clearErrors,reset } = useForm();
  ...
  return (
    <>
      ...
      <Flex justify="center" align="center" minHeight="100vh" bg="gray.50">
        <Box width="full" maxW="lg" mx="auto" p={8} borderWidth={1} borderRadius="lg" bg="white" boxShadow="lg">
          <Heading as="h1" mb={6} textAlign="center">Registration Form</Heading>
